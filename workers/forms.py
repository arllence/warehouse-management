...
class Operation(forms.Form):
    ...
    widget=forms.TextInput(attrs={'class':'form-field','id':'obj1', 'placeholder': 'Object 1'}))

    obj2 = forms.CharField(max_length=32, label='', required=False,
    widget=forms.TextInput(attrs={'class':'form-field','id':'obj2', 'placeholder': 'Object 2'}))

    obj3 = forms.CharField(max_length=32, label='', required=False,
    widget=forms.TextInput(attrs={'class':'form-field','id':'obj3', 'placeholder': 'Object 3'}))

    obj4 = forms.CharField(max_length=32, label='', required=False,
    widget=forms.TextInput(attrs={'class':'form-field','id':'obj4', 'placeholder': 'Object 4'}))

    obj5 = forms.CharField(max_length=32, label='', required=False,
    widget=forms.TextInput(attrs={'class':'form-field','id':'obj5', 'placeholder': 'Object 5'}))
